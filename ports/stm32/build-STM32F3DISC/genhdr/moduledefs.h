...
#undef MODULE_DEF_MP_QSTR_PYB
#define MODULE_DEF_MP_QSTR_PYB { MP_ROM_QSTR(MP_QSTR_pyb), MP_ROM_PTR(&pyb_module) },

extern const struct _mp_obj_module_t stm_module;
#undef MODULE_DEF_MP_QSTR_STM
#define MODULE_DEF_MP_QSTR_STM { MP_ROM_QSTR(MP_QSTR_stm), MP_ROM_PTR(&stm_module) },
...
#define MICROPY_REGISTERED_MODULES \
    ...
    MODULE_DEF_MP_QSTR_PYB \
    MODULE_DEF_MP_QSTR_STM \
